...
HOME_OVERRIDES = {
    "ko": {
        ...
        "description": "Flowmatic은 품질·가공·운영·물류 데이터를 공통 제조 문맥과 Event Core로 통합하는 Factory Operating Intelligence 아키텍처입니다.",
        "body": "현장 신호를 Event로 구조화하고, 도메인별 판단을 사람과 설비의 후속 행동에 연결합니다.",
        ...
        "workflow_body": "데모·프로토타입·내부 검증 MVP를 구분하고 Event Core·Control Tower를 후속 통합 단계로 명시합니다.",
    },
    "en": {
        "title": "Flowmatic | Factory Operating Intelligence",
...
DOMAINS = [
    {
        ...
        "body": l(
            "검사 증거와 LOT를 기준으로 손실을 정량화하고 개선 우선순위·업무·효과·재발을 관리합니다.",
    ...
    },
    {
        ...
        "body": l(
            "NC·CT·보정·작업표준·공구정보를 단일 가공 문맥으로 통합합니다.",
    ...
    },
    {
        ...
        "body": l(
            "구매·소모품·공구비·공수를 생산량 기준으로 정규화해 이상 후보를 식별합니다.",
    ...
    },
    {
        ...
        "body": l(
            "자재 요구를 실행 작업으로 전환하고 배정·이동·투입 완료를 추적합니다.",
...
PAGES = {
    ...
    "operations-intelligence": {
        ...
        "hero": l("구매·소모·공수·공구비의|운영 문맥 통합", "Connect purchasing, consumption, labor, and tool economics|to the real operating context.", "اربط المشتريات والاستهلاك والعمل|واقتصاديات الأدوات|بسياق التشغيل الفعلي."),
        "body": l("반복 입력을 줄이고 자원 사용량을 생산량 기준으로 정규화해 비용 이상 후보를 식별합니다.", "Reduce repetitive input, normalize resource use by production, and surface abnormal cost movement early.", "تقليل الإدخال المتكرر وتطبيع استهلاك الموارد حسب الإنتاج وإظهار حركة التكلفة غير الطبيعية مبكرًا."),
        "status": l("Functional MVP / internal validation", "Functional MVP / internal validation", "MVP وظيفي / تحقق داخلي"),
    ...
    "logistics-intelligence": {
        ...
        "hero": l("자재 요구부터|투입 확인까지", "Turn material demand|into executable work.", "حوّل طلب المواد|إلى عمل قابل للتنفيذ."),
        "body": l("부족 감지, 우선순위 산정, 실행자 배정, 이동, 투입 확인을 단일 Event lifecycle로 관리합니다.", "Detect shortages, calculate priority, assign people, forklifts, or AMRs, and confirm actual input.", "اكتشاف النقص وحساب الأولوية والتوزيع على الأشخاص أو الرافعات أو AMR ثم تأكيد الإدخال الفعلي."),
        "status": l("Prototype integration", "Prototype integration", "تكامل نموذجي أولي"),
