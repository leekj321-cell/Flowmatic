...
PAGES = {
    "machining-intelligence": {
        ...
        "sections": [
            ...
            ("Measurement / Compensation + Work Standard", l("Prototype framework / symbolic prototype", "Prototype framework / symbolic prototype", "إطار أولي / نموذج رمزي"), l("Feature·position·operation 문맥의 보정기록과 before/after NC preview를 작업자 표준으로 연결합니다. 전체 좌표변환 자동화는 아직 완료되지 않았습니다.", "Connect feature, position, and operation compensation records plus before/after NC previews to operator standards. Full coordinate-transform automation is not complete.", "ربط سجلات التعويض وسياق الموضع والعملية ومعاينة NC قبل/بعد بمعايير المشغّل. أتمتة تحويل الإحداثيات الكاملة غير مكتملة."), ["Compensation record", "Before / after NC preview", "Operator-facing symbolic work standard"]),
